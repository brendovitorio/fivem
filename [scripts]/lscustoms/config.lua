vehicleCustomisationPrices = {
	cosmetics = 1300,
	respray = 1047,
	engines = { 14000, 29000, 44000, 59000, 74000, 89000 },
	brakes = { 4000, 9000, 14000, 19000, 24000, 29000 },
	transmission =  { 14000, 29000, 44000, 59000, 74000, 89000 },
	suspension = { 7000, 15000, 23000, 31000, 39000, 47000 },
	shield = { 19000, 39000, 59000, 79000, 99000, 119000 },
	turbo = 14000,
	wheels = 2500,
	customwheels = 500,
	wheelsmoke = 500,
