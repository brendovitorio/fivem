...
function openTattooShop()
	...
	rEVOLT.playAnim(true,{"mp_sleep","bind_pose_180"},true)
	rEVOLT.playAnim(true,{"missfam5_yoga","a2_pose"},true)
...
RegisterNUICallback("handsup",function(Data,Callback)
	...
	if IsEntityPlayingAnim(Ped,"random@mugging3","handsup_standing_base",3) then
		...
		rEVOLT.playAnim(true,{"random@mugging3","handsup_standing_base"},true)
	end
