	...
	if animacoes[Name] and not IsPedArmed(Ped,7) and not IsPedSwimming(Ped) and GetEntityHealth(Ped) > 100 and not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Buttons"] and not LocalPlayer["state"]["Cancel"] and not LocalPlayer["state"]["Handcuff"] then
		...
		if not IsPedInAnyVehicle(Ped) and not animacoes[Name]["cars"] then
			...
			if animacoes[Name]["altura"] and not animacoes[Name]["anim"] then
				rEVOLT.createObjects("","",animacoes[Name]["prop"],animacoes[Name]["flag"],animacoes[Name]["mao"],animacoes[Name]["altura"],animacoes[Name]["pos1"],animacoes[Name]["pos2"],animacoes[Name]["pos3"],animacoes[Name]["pos4"],animacoes[Name]["pos5"])
			elseif animacoes[Name]["altura"] and animacoes[Name]["anim"] then
				rEVOLT.createObjects(animacoes[Name]["dict"],animacoes[Name]["anim"],animacoes[Name]["prop"],animacoes[Name]["flag"],animacoes[Name]["mao"],animacoes[Name]["altura"],animacoes[Name]["pos1"],animacoes[Name]["pos2"],animacoes[Name]["pos3"],animacoes[Name]["pos4"],animacoes[Name]["pos5"])
			elseif animacoes[Name]["prop"] then
				rEVOLT.createObjects(animacoes[Name]["dict"],animacoes[Name]["anim"],animacoes[Name]["prop"],animacoes[Name]["flag"],animacoes[Name]["mao"])
			elseif animacoes[Name]["dict"] then
				rEVOLT.playAnim(animacoes[Name]["walk"],{animacoes[Name]["dict"],animacoes[Name]["anim"]},animacoes[Name]["loop"])
			else
				rEVOLT.playAnim(false,{ task = animacoes[Name]["anim"] },false)
			end
		else
