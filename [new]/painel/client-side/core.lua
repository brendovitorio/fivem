...
vRPS = getInterfaceWithFallback(Tunnel,{"rEVOLT","revolt","REVOLT","vRP"})
if not vRP then
...
RegisterNUICallback("searchUser",function(data,cb)
	local r = vSERVER.searchUser(data["term"] or data["passaporte"] or "")
	cb({ result = r })
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- EXCLUIR PROCURADO
...
RegisterNUICallback("getInitialData", function(_,cb)
	cb(vSERVER.getInitialData())
end)

RegisterNUICallback("searchVehicles",function(data,cb)
	cb(vSERVER.searchVehicles(data.term or ""))
end)
...
RegisterNUICallback("getPenalArticles",function(data,cb)
	cb(vSERVER.getPenalArticles())
end)
RegisterNUICallback("createPenalArticle",function(data,cb)
	cb(vSERVER.createPenalArticle(data))
end)
RegisterNUICallback("updatePenalArticle",function(data,cb)
	cb(vSERVER.updatePenalArticle(data))
end)
RegisterNUICallback("deletePenalArticle",function(data,cb)
	cb(vSERVER.deletePenalArticle(data.id))
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- OPENSYSTEM
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterNetEvent("revolt:Mdt")
AddEventHandler("revolt:Mdt",function()
	TriggerEvent("police:Mdt")
end)
-----------------------------------------------------------------------------------------------------------------------------------------
