...
function UIMenu:ProcessControl()
    ...
    if not self.UpPressed then
        if self.Controls.Up.Enabled and (IsDisabledControlJustPressed(0, 208) or IsDisabledControlJustPressed(1, 208) or IsDisabledControlJustPressed(2, 208) or IsDisabledControlJustPressed(0, 316) or IsDisabledControlJustPressed(1, 316) or IsDisabledControlJustPressed(2, 316) or IsDisabledControlJustPressed(2, 316)) then
            Citizen.CreateThread(function()
                self.UpPressed = true
                ...
                self:UpdateScaleform()
                Citizen.Wait(120)
                while self.Controls.Up.Enabled and (IsDisabledControlPressed(0, 208) or IsDisabledControlPressed(1, 208) or IsDisabledControlPressed(2, 208) or IsDisabledControlPressed(0, 316) or IsDisabledControlPressed(1, 316) or IsDisabledControlPressed(2, 316) or IsDisabledControlPressed(2, 316)) do
                    if #self.Items > self.Pagination.Total + 1 then
                        self:GoUpOverflow()
                    else
                        self:GoUp()
    ...
    if not self.DownPressed then
        if self.Controls.Down.Enabled and (IsDisabledControlJustPressed(0, 207) or IsDisabledControlJustPressed(1, 207) or IsDisabledControlJustPressed(2, 207) or IsDisabledControlJustPressed(0, 317) or IsDisabledControlJustPressed(1, 317) or IsDisabledControlJustPressed(2, 317)) then
            Citizen.CreateThread(function()
                ...
                self:UpdateScaleform()
                Citizen.Wait(120)
                while self.Controls.Down.Enabled and (IsDisabledControlPressed(0, 207) or IsDisabledControlPressed(1, 207) or IsDisabledControlPressed(2, 207) or IsDisabledControlPressed(0, 317) or IsDisabledControlPressed(1, 317) or IsDisabledControlPressed(2, 317)) do
                    if #self.Items > self.Pagination.Total + 1 then
                        self:GoDownOverflow()
                    else
                        self:GoDown()
