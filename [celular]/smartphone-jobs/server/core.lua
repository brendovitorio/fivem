API = {}
load(LoadResourceFile('revolt', 'lib/utils.lua'))()
local Proxy = module('lib/Proxy')
local rEVOLT = Proxy.getInterface("rEVOLT")

API.getId = rEVOLT.Passport
API.getBank = function(id)
  local source = rEVOLT.Source(id)
  return rEVOLT.GetBank(source)
end
API.addBank = function(id, amount) rEVOLT.GiveBank(id, amount) end
API.subBank = function(id, amount) rEVOLT.RemoveBank(id, amount) end
API.giveItem = rEVOLT.GiveItem
API.getIdentity = rEVOLT.Identities
