...
AddEventHandler("hud:Scuba",function()
	if Mask or Tank then
		...
		local Progression,Network = rEVOLTS.CreateObject("p_s_scuba_tank_s",Coords["x"],Coords["y"],Coords["z"])
		if Progression then
		...
		local Progression,Network = rEVOLTS.CreateObject("p_s_scuba_mask_s",Coords["x"],Coords["y"],Coords["z"])
		if Progression then
